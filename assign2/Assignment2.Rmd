...
-   Find out the main factors affect the price.
...
-   **Justification:** Boxplots are effective for displaying the central tendency, spread, and potential outliers in a dataset.
...
### What's the main factor affect the price

**Design Thoughts:**

-   **Visual Element:** A pair plot (scatterplot matrix) is suitable for visualizing relationships between multiple variables.
...
-   **Justification:** A pair plot allows us to examine potential correlations and patterns between the main factors that could affect property prices.
    Scatterplots show the relationship between two numerical variables, and histograms show the distribution of individual variables.
